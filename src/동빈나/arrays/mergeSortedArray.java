 ...
 *
 * 2021.08.22
 * Q. You are given two integer 동빈나.arrays nums1 and nums2, sorted in non-decreasing order,
 ...
 * Output: [1,2,2,3,5,6]
 * Explanation: The 동빈나.arrays we are merging are [1,2,3] and [2,5,6].
 ...
 * Output: [1]
 * Explanation: The 동빈나.arrays we are merging are [1] and [].
